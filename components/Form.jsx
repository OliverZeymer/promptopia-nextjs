...
const Form = ({ type, post, setPost, submitting, handleSubmit }) => {
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form onSubmit={handleSubmit} className=" border-none mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        <label>
        ...
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">
            Tag of Prompt <span className="font-normal">(#product, #webdevelopment, #idea, etc.)</span>
          </span>
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          <button type="submit" disabled={submitting} className="px-5 py-1.5 min-w-[80px] text-sm bg-primary-orange rounded-full text-white">
            {submitting ? <Loader /> : type}
          </button>
        </div>
      </form>
    </section>
